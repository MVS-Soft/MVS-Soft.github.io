              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3  lg:w-full ">
                    ...
                    We offer a free webinar. With an hour, MVS-Soft engineers will figure out what our customers' goals, needs and pain points are. If MVS-Soft can help, we will discuss different options based on our experience. At the end of our webinar, the MVS-Soft engineers will provide initial feedback! 
                    </p>
                    <List text="Step  2   -  Create a Concept" />
                    <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                    MVS-Soft creates a concept with the aim of providing an offer with a cost estimate.
...
MVS-Soft initializes a customer-specific project. Resources, data pipelines and a special team with the required know-how is formed to fulfill the project on time & best quality possible. 
Agile development. Every 2 weeks MVS-Soft presents the progress of the current work. The customer can submit feedback and change requests. Test & communication with the customer are provided on a weekly basis.
                    </p>
...
MVS-Soft offers a support and additional service if needed/ required.
                    </p>
                  </div>
{/* 
