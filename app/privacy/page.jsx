          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                MVS-Soft cares deeply about the privacy of its visitors and users. To that end, this Privacy Policy (“Privacy Policy”) describes how MVS-Soft Ltd., together with its affiliated companies worldwide , collect, use, and share your Personal Information, as well as an explanation of the data rights you may have in that Personal Information. This Privacy Policy applies to all MVS-Soft users, including unregistered visitors, registered users, and premium users (collectively, “Users”, “you”, or “your”), and to all MVS-Soft services, including our websites, web applications, mobile applications, and related services. This Privacy Policy is not intended to override the terms of any contract you have with us, nor any rights you may have under other applicable data privacy laws.

Prior to accessing or using our Services, please read this policy and make sure you fully understand our practices in relation to your Personal Information.  If you read and fully understand this Privacy Policy, and remain opposed to our practices, you must immediately leave and discontinue all use of any of our Services.  If you have any questions or concerns regarding this policy, please contact us at privacy@mvs-soft.eu.
                </p>
...
We also collect information that is provided to us by jobs candidates (“Applicants”), when they apply to any of the open positions published at https://MVS-Soft.eu/jobs, by e-mail or or through any other means provided by us. We understand that privacy and discreetness are crucial to our Applicants, and are committed to keep Applicants Personal Information  private and use it solely for MVS-Soft internal recruitment purposes (including for identifying Applicants, evaluating their applications, making hiring and employment decisions, and contacting Applicants by phone or in writing).
If you previously submitted your Applicants Personal Information to MVS-Soft, and now wish to access it, update it or have it deleted from MVS-Soft systems, please contact us at carrer@mvs-soft.eu
                  </p>
                  ...
                  <ul>
                  <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                  Law Enforcement, Legal Requests and Duties: MVS-Soft may disclose or otherwise allow access to your Personal Information pursuant to a legal request, such as a subpoena, legal proceedings, search warrant or court order, or in compliance with applicable laws, if we have a good faith belief that the law requires us to do so, with or without notice to you.​
                  </li>
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                    Protecting Rights and Safety: MVS-Soft may share your Personal Information if we believe in good faith that this will help protect the rights, property or personal safety of MVS-Soft, any of our Users, any Users-of-Users, or any member of the general public, with or without notice to you. Location of our Personal Information
                    </li>
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                  ...
                  <p className="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                  MVS-Soft Ltd. is based in Germany. MVS-Soft affiliates and Third-Party Service Providers that store or process your Personal Information on MVS-Soft's behalf are contractually committed to keep it protected and secured, in accordance with industry standards and regardless of any lesser legal requirements which may apply in their jurisdiction.
                  </p>
